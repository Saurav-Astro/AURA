      ...
      return (
        <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-xl">
          ...
          <div className="space-y-1">
            <p className="text-xl font-black text-slate-900 italic">{payload[0].value.toFixed(0)} <span className="text-[9px] opacity-40 not-italic uppercase tracking-tight text-slate-500">Records</span></p>
            {payload[1] && (
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between border-b border-slate-200 pb-6">
        <div className="space-y-2">
          <div className="flex items-center gap-3">
            <h2 className="text-3xl font-black tracking-tight text-slate-900 font-sans uppercase italic leading-none">Institutional Projections</h2>
            <TrendingUp className="h-4 w-4 text-primary opacity-60" />
          </div>
          <p className="text-slate-500 font-semibold italic uppercase tracking-[0.15em] text-[10px]">Autoregressive Integrated Moving Average (ARIMA).</p>
        </div>
        <div className="flex gap-2">
            {forecast.is_synthetic && (
                <Badge className="h-9 px-4 border-amber-500/20 text-amber-600 font-black uppercase tracking-[0.15em] text-[8px] bg-amber-50 rounded-lg italic">
                    STATISTICAL MODEL
                </Badge>
            )}
            <Badge className="h-9 px-4 border-rose-500/20 text-rose-600 font-black uppercase tracking-[0.15em] text-[8px] bg-rose-50 rounded-lg">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <Card className="lg:col-span-2 institutional-card p-0 overflow-hidden relative group border-none">
          <div className="px-8 py-5 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
            <div className="space-y-1">
                <h4 className="text-xl font-black italic uppercase tracking-tighter text-slate-900 font-sans">Predictive Trajectory</h4>
                ...
                <div className="relative z-10 space-y-4">
                    ...
                    <div className="p-4 rounded-xl bg-white/10 border border-white/10 backdrop-blur-md">
                        <div className="flex items-center justify-between">
                            ...
                            <span className="text-xl font-black italic text-white">{latestProjected?.predicted.toFixed(0)}</span>
                        </div>
                    </div>
                </div>
            </Card>

            <Card className="institutional-card bg-white border border-slate-200 group p-8 min-h-[220px]">
                <div className="flex items-start gap-3 mb-6">
                    <Target className="h-4 w-4 text-rose-500 opacity-60" />
                    <div>
                        <h4 className="text-base font-black italic uppercase tracking-tighter text-slate-900">Statistical Gap</h4>
                ...
                <div className="space-y-4">
                    <div className="space-y-1">
                        <div className="flex justify-between text-[8px] font-black uppercase tracking-widest">
                            ...
                            <span className="text-rose-600">95% RELIABLE</span>
                        </div>
        ...
        <Card className="lg:col-span-4 institutional-card p-0 overflow-hidden relative group border-none">
          <div className="px-8 py-5 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
            <div className="space-y-1">
                <h4 className="text-xl font-black italic uppercase tracking-tighter text-slate-900 font-sans">Confidence Threshold Mapping</h4>
                <p className="text-[9px] font-bold uppercase tracking-[0.15em] text-slate-500 opacity-60">Linear probability area map.</p>
            </div>
            <ShieldCheck className="h-5 w-5 text-rose-600 opacity-60" />
          </div>
          <CardContent className="p-8">
      ...
      <div className="flex items-center justify-center">
          <div className="flex items-center gap-3 bg-white border border-slate-200 px-6 py-4 rounded-xl shadow-sm">
              ...
              <p className="text-[9px] font-black uppercase tracking-[0.3em] text-slate-500 italic">
                Aura Intelligence uses <span className="text-slate-900 font-black">Autoregressive Optimization</span> protocol.
              </p>
          </div>
      </div>
    </div>
